function [error_train, error_val, Theta1, Theta2] = ...
    ...
    input_layer_size, hidden_layer_size, num_labels, lambda, nIter, ...
...
if ~exist('initial_Theta1', 'var') || ~exist('initial_Theta2', 'var') || isempty(initial_Theta1) || isempty(initial_Theta2)
...
%    error_train(i) = linearRegCostFunction( X(1:i,:), y(1:i), theta, 0 );
    pred = predict(Theta1, Theta2, Xsel);

    error_train(i) = 100 - mean(double(pred == ySel)) * 100;

    pred = predict(Theta1, Theta2, XvalSel);
